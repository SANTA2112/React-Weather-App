...
export const forecastWeather = (lat, lon) => getJSON(`https://cors-anywhere.herokuapp.com/https://api.weather.yandex.ru/v1/forecast?lat=${lat}&lon=${lon}&hours=false&limit=5&extra=false&lang=ru_RU`, {
  headers: {
